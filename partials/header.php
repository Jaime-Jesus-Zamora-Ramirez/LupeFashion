    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link nav-color" href="../lupefashion/views/VerProductos.php">Productos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-color" href="../lupefashion/views/Contactos.php">Contacto</a>
          </li>
          <?php if (!isset($_SESSION['usuario'])): ?>
            <!-- Si NO está logueado, muestra solo el botón de Log In -->
            <li class="nav-item">
